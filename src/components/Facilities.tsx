...
const Facilities: React.FC<FacilitiesProps> = ({ 
  ...
  // 시설 유형별 개수
  const typeStats = {
    landscape: facilities.filter(f => f.type === 'landscape').length,
    equipment: facilities.filter(f => f.type === 'equipment').length,
    shower: facilities.filter(f => f.type === 'shower').length
  };
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        {typeStats.landscape > 0 && (
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">센터 전경</h3>
              <p className="text-sm text-gray-600 mb-2">
                {typeStats.landscape}개의 공간 소개
                  </p>
        ...
        {typeStats.equipment > 0 && (
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 hover:shadow-md transition-shadow">
              ...
              <div className="text-center">
              <h3 className="text-lg font-bold text-gray-900 mb-2">운동 기구</h3>
              <p className="text-sm text-gray-600 mb-2">
                {typeStats.equipment}개의 기구 소개
                  </p>
                  <p className="text-xs text-gray-500">
                최신식 운동기구 완비
                  </p>
        ...
        {typeStats.shower > 0 && (
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 hover:shadow-md transition-shadow">
              <div className="flex items-center justify-center mb-4">
                ...
                <div className="text-center">
              <h3 className="text-lg font-bold text-gray-900 mb-2">샤워 시설</h3>
              <p className="text-sm text-gray-600 mb-2">
                {typeStats.shower}개의 시설 소개
                  </p>
                  <p className="text-xs text-gray-500">
                깔끔하고 쾌적한 시설
                  </p>
